...
! have been set based on the corresponding runtime parameters.
  ...
  if(refine_var_string_1 /= "none") then
     ...
     if (gr_refine_var(gr_numRefineVars+1) .LE. 0) then
        ...
        call RuntimeParameters_get( "refine_level_1",  gr_refine_level(gr_numRefineVars) )
     end if
  end if
  ...
  if(refine_var_string_2 /= "none") then
     ...
     if (gr_refine_var(gr_numRefineVars+1) .LE. 0) then
        ...
        call RuntimeParameters_get( "refine_level_2",  gr_refine_level(gr_numRefineVars) )
     end if
  end if
  ...
  if(refine_var_string_3 /= "none") then
     ...
     if (gr_refine_var(gr_numRefineVars+1) .LE. 0) then
        ...
        call RuntimeParameters_get( "refine_level_3",  gr_refine_level(gr_numRefineVars) )
     end if
  end if
  ...
  if(refine_var_string_4 /= "none") then
     ...
     if (gr_refine_var(gr_numRefineVars+1) .LE. 0) then
        ...
        call RuntimeParameters_get( "refine_level_4",  gr_refine_level(gr_numRefineVars) )
     end if
  end if
